...
def get_chapters():
    ...
    headers = {
        ...
        'x-csrf-token': 'ErJghzedf4jJzXM7SIx35oG7DVwjICV4yYq+3h21KhTsOgKoOhuAzNaII6HImHuJagL6oZhjYUkfW6fKJWnipg==',
        'x-datadog-origin': 'rum',
        'x-datadog-parent-id': '7333750845614247000',
        'x-datadog-sampled': '1',
        'x-datadog-sampling-priority': '1',
        'x-datadog-trace-id': '4452042950269861479',
        'Connection': 'keep-alive',
        'Referer': 'https://www.blinkist.com/en/nc/new-reader/the-4-stages-of-psychological-safety-en',
